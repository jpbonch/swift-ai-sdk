...
See [Middleware](/docs/middleware) for custom middleware and persistent cache
adapters, [Telemetry](/docs/telemetry) for all spans, and
[Errors and retries](/docs/errors) for the complete error list.
